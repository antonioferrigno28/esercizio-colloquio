    ...
    fetch("save-order.php", {
      ...
      .then((data) => {
        ...
        if (data.success) {
          ...
          const finalModal = new window.bootstrap.Modal(
            document.getElementById("finalModal")
          );
          //Mostra la modale di conferma ordine
          finalModal.show();
        } else {
          //altrimenti mostra un messaggio di errore
          const errorModal = new window.bootstrap.Modal(
      ...
      <div className="container py-2">
        ...
        >
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title fw-semibold" id="finalModalLabel">
                  Ordine Confermato
                </h5>
                <button
                  type="button"
              ...
              <div className="modal-body">
                <p>Ordine eseguito con successo!</p>
              </div>
              <div className="modal-footer">
                <button
                  className="btn btn-secondary btn-animation btn-grey fw-semibold"
